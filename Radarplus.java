...
public class Radarplus
{
	public static void main(String[]aaaaaargs)
	{
		...
		// These three integers are the main data points used in my calculation functions.
		boolean doubleZone = false;
		// This boolean data point is whether the driver was in a double zone (2 * ticket value)
		String s = new String();
		// This string is used to represent the Scanner line and refresh the Scanner integer.
		...
		// The user will type an integer and a return carriage. This reads the integer...
		s = radarBot.nextLine();
...
radarBot.close();
	...
	// This function is used to calculate and apply the double zone penalty onto the ticket value.
	{
		int temp;
		temp = ticket * dzone;
		return temp;
	...
	// This function is used to calculate and apply the priors penalty onto the ticket value.
	{
		int temp;
		temp = ticket * priors;
		return temp;
